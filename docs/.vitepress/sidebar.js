  ...
  "/back-end/frontend-backend-guide/": [
    {
      text: "前端工程师后端学习指南",
      items: [
        { text: "教程总览", link: "/back-end/frontend-backend-guide/index.md" },
        { text: "01. 项目整体架构", link: "/back-end/frontend-backend-guide/01-项目整体架构.md" },
        { text: "02. 一个请求的完整链路", link: "/back-end/frontend-backend-guide/02-一个请求的完整链路.md" },
        { text: "03. 核心技术点拆解", link: "/back-end/frontend-backend-guide/03-核心技术点拆解.md" },
        { text: "04. 目录结构导读", link: "/back-end/frontend-backend-guide/04-目录结构导读.md" },
        { text: "05. 关键注解速查", link: "/back-end/frontend-backend-guide/05-关键注解速查.md" },
        { text: "06. 给前端的学习路径", link: "/back-end/frontend-backend-guide/06-给前端的学习路径.md" },
        { text: "07. 动手练习", link: "/back-end/frontend-backend-guide/07-动手练习.md" },
        { text: "08. 术语对照表", link: "/back-end/frontend-backend-guide/08-术语对照表.md" },
        { text: "09. 学习资源推荐", link: "/back-end/frontend-backend-guide/09-学习资源推荐.md" },
      ],
    },
  ],
  "/back-end/database/": [
